...
const Single = (props) => {
  ...
  const clickHandler = (event) => {
    ...
    setCoordinates({
      x: event.pageX,
      y:
        dots.getBoundingClientRect().top +
  ...
  const [itemsIndex1, setItemIndex1] = useState(0);
  return (
      ...
      <div className={styles.firstRow}>
        {option.map((dat, index) => (
          <div
            className={cx(
              styles.todo,
              itemsIndex == index ? styles.priority1 : null
            )}
      ...
      <div className={styles.scrollTask}>
        {[0, 12, 3, 4, 5].map((dat) => (
          <div className={styles.box}>
            ...
            <div className={styles.desc}>Payment of internet bill</div>
            <div className={styles.topBox}>
      ...
      {show ? (
        ...
        >
          <div className={styles.absoluteDropdown}>
            ...
            <div className={styles.options}>
              <AiOutlineUsergroupAdd />{" "}
              <div className={styles.foodDrop} onMouseEnter={() => showDiv()}>
                Assign to Staff
              </div>
            </div>
            <div className={styles.options}>
              <IoCheckmarkDone />{" "}
              <div className={styles.food}>Mark as Done</div>
            </div>
          </div>
            ...
            {stories.map((dat) => (
              <div className={styles.options2}>
                <div className={styles.optional}>
                  {" "}
                  <img
                    className={styles.imageTop2}
                    src="/images/user.jpeg"
                  />{" "}
                  <div className={styles.food}>Anis Acharya</div>
                </div>
                <div className={styles.tasks}>24 Task remaining</div>
              </div>
            ))}
          </div>
        </div>
