...
const Header=(props)=>{
    const [stories,setStories]=useState([{'Name':'Add Expense','image':'/demo.png','value':'44'},{'Name':'Add Order','image':'/demo.png','value':'44'},{'Name':'Add Notes','image':'/demo.png','value':'44'}])
    ...
    return(
        <div className={styles.storiesContainer}> 
            <div className={styles.stories}>
                ...
                {stories.slice(0,3).map((dat)=><div className={styles.storiesDiv}  onClick={()=>{props.modalHandle(dat.Name);}} >
