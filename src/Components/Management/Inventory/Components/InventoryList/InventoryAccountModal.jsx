...
function InventoryAccountModal({ setCreateInventoryAccount }) {
  const saveUnit = () => {
    setCreateInventoryAccount(false);
  };

  return (
    <div className={styles.fixed}>
      <div
        onClick={() => setCreateInventoryAccount(false)}
...
export default InventoryAccountModal;
