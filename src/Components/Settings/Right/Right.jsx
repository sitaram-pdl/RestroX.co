  ...
  const [items, setItems] = useState([
    {
      ...
      id: "AAA",
      image:
        "https://i2.wp.com/www.spainonafork.com/wp-content/uploads/2019/05/stew1-1-11.png?fit=750%2C750&ssl=1",
    },
    {
      name: "Spicy Seasoned Seafood",
      id: "AAAAAA",
    ...
    <div className={styles.container}>
      <div className={styles.leftContainer}>
        <div className={styles.title}>
          ...
          <div className={styles.titleName}>Chicken Pasta</div>
        </div>
            ...
            {items.map((dat) => (
              <div className={styles.tableWBg}>
                ...
                <div className={styles.items}>
                  ...
                  <div className={styles.desc}>{dat.name}</div>
                </div>
